# Appendix — Sankey interaction spec: full proposals, measurements, borrow matrix

Long-form companion to `2026-09-06-sankey-interaction.md` (the short, decision-ready version). Section numbers (§3.x, §6, §7) are what the short doc cites.
