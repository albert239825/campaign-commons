...
| Q-13 | **Answered by D-82.** Use an LLM-assisted first pass in a separately labelled, provenance-carrying machine layer with human review; record-based fields remain authoritative. | D-82 | Albert |
