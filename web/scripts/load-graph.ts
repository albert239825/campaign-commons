/**
 * Load one race's published artifacts (chains, entities, donors, ads, ledger, trails) into Neo4j (D-79). Idempotent: nodes and edges are MERGEd on their keys, so re-running
