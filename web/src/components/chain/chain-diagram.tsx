  ...
  return (
    <figure className="chain-figure" ref={figRef}>
      <div
        ...
        aria-label={`${graph.hasOut ? "Money into and out of" : "Funding chain into"} ${view.rootName}: ${L.nodes.length} nodes, ${L.ribbons.length} edges drawn. Arrow keys move between nodes, Home returns to the spender, Enter opens a node's details, Escape clears. Full detail in the table below.`}
