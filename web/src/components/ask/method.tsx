  ...
  return (
    <footer className="ask-method border-t pt-4 space-y-2">
      <p className="text-xs text-neutral-500">
        ...
        one of the four supported question types and, for issue questions, one issue from the fixed list of ten, plus one candidate or committee from this race&apos;s list, or nothing. It is given only that list and the question; it does
