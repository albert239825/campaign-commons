...
import { UNWALKED_COLOR, UNWALKED_LABEL, VISIBILITY_COLORS, VISIBILITY_LABELS } from "@campaign-commons/contracts";
import { Breadcrumbs, Card } from "@/components/ui";

export default function MethodologyPage() {
  return (
    <div className="detail-page methodology-page">
      <Breadcrumbs items={[{ href: routes.home(), label: "Races" }, { label: "Methodology" }]} />
      <DetailHeader label="Behind the public record" title="How we follow the money.">
        <p>What the records show, how we connect them, and where the evidence ends.</p>
      </DetailHeader>
      <div className="detail-sections">
        ...
        <div className="detail-content">
          ...
          <div id="visibility" className="detail-section">
          ...
          <div id="money-and-targeting" className="detail-section">
          ...
          <div id="traceability" className="detail-section">
          ...
          <div id="conduits" className="detail-section">
            <Card title="Conduits">
              <p className="text-sm">
          ...
          <div id="dossiers" className="detail-section">
            <Card title="Dossiers">
              <p className="text-sm">
