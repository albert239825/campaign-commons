...
import { getIssues, getLedger, getRace, getStories, hasChain, listRaceIds } from "@/lib/data";
...
export default async function RaceLedgerPage({ params }: { params: Promise<{ raceId: string }> }) {
  ...
  return (
    <RaceShell race={race} section="overview" status={ledger.data_status} variant="dashboard" header={banner}>
      <RaceSections
